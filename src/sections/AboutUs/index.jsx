    ...
    <section id="about-us" className="px-4 py-10 lg:py-20">
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 lg:gap-8 pt-5 lg:pt-10 justify-items-center">
          <div className="flex flex-col rouneded-[8px] gap-2 w-full items-center cursor-pointer group bg-white/5 backdrop-blur-sm border border-[#DDA435] rounded-2xl p-6 text-center hover:bg-text-[#FFD700] transition-all duration-300 hover:scale-105">
          ...
          <div className="flex flex-col rouneded-[8px] gap-2 w-full items-center cursor-pointer group bg-white/5 backdrop-blur-sm border border-[#DDA435] rounded-2xl p-6 text-center hover:bg-text-[#DDA435] transition-all duration-300 hover:scale-105">
